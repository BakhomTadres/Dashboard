  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row">
         <div className="pl-4 md:pl-20 py-20 sm:pt-25 pr-4 md:pb-6 min-h-[calc(100vh)] w-full lg:w-[80%] bg-mauve-100 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            {tasks.filter((t) => !t.completed && (activeFilter === "all" || t.priority === activeFilter)).length === 0 && (
              <p className="text-gray-400 col-span-full text-center py-12">No pending tasks.</p>
            )}
          </div>
        </div>
